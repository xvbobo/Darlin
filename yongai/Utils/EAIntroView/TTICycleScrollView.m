...
@implementation TTICycleScrollView
...
-(void)setDatasource:(id<TTICycleScrollViewDatasource>)datasource{
...
- (void)reloadData
{
    ...
    _totalPages = (NSInteger)[self.datasource numberOfPages];
...
- (void)getDisplayImagesWithCurpage:(int)page {
    ...
    if (self.datasource != nil && [self.datasource respondsToSelector:@selector(pageAtIndex:)]) {
