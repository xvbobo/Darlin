...
#define FOREGROUND_STAR_IMAGE_NAME @"comment_full_star"
#define BACKGROUND_STAR_IMAGE_NAME @"comment_blank_star"
...
- (instancetype)initWithFrame:(CGRect)frame fullImage:(NSString *)full blankImage:(NSString *)blank{
    self.fullStarIcon = full;
    self.blankStarIcon = blank;
    return [self initWithFrame:frame numberOfStars:DEFALUT_STAR_NUMBER];
}
...
- (void)buildDataAndUI {
    ...
    self.foregroundStarView = [self createStarViewWithImage:self.fullStarIcon];
    self.backgroundStarView = [self createStarViewWithImage:self.blankStarIcon];
